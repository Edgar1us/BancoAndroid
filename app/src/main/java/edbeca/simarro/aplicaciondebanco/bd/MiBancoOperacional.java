...
import edbeca.simarro.aplicaciondebanco.pojo.Cuenta;
import edbeca.simarro.aplicaciondebanco.pojo.Movimiento;
...
public class MiBancoOperacional {
    ...
    protected MiBancoOperacional(Context context){
        miBD = MiBD.getInstance((View.OnClickListener) context);
    }
