package edbeca.simarro.aplicaciondebanco.bd;
...
import edbeca.simarro.aplicaciondebanco.dao.ClienteDAO;
import edbeca.simarro.aplicaciondebanco.dao.CuentaDAO;
import edbeca.simarro.aplicaciondebanco.dao.MovimientoDAO;
...
public class MiBD extends SQLiteOpenHelper {
    ...
    public static MiBD getInstance(View.OnClickListener context) {
        if(instance == null) {
     ...
     *
     * @param context*/
    protected MiBD(View.OnClickListener context) {
        super((Context) context, database, null, version );
    }
